...
- このリポジトリをcloneして使用
- プロンプトテンプレート、ガイドを含む
- リポジトリURL: https://github.com/ist-whitebox/ai-hackathon-2025-ideathon.git

## 🤖 Amazon Q設定の工夫

このワークショップの最大の特徴は、**2つの異なるAmazon Q設定を使い分ける**ことです：
...
💡 **ポイント**: 作業内容に応じてVSCodeで開くフォルダを変えることで、最適なAIサポートが得られます。これがこのワークショップの「キモ」です。
